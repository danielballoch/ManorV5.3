...
async function getPropertyData(){
    ...
    // console.log("Agent: " + allData[0][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[0][0].PropertyAddress1+allData[0][0].PropertyAddress2+allData[0][0].PropertyAddress3)
    // console.log("Agent: " + allData[1][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[1][0].PropertyAddress1+allData[1][0].PropertyAddress2+allData[1][0].PropertyAddress3)
    // console.log("Agent: " + allData[2][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[2][0].PropertyAddress1+allData[2][0].PropertyAddress2+allData[2][0].PropertyAddress3)
    // console.log("Agent: " + allData[3][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[3][0].PropertyAddress1+allData[3][0].PropertyAddress2+allData[3][0].PropertyAddress3)
    // console.log("Agent: " + allData[4][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[4][0].PropertyAddress1+allData[4][0].PropertyAddress2+allData[4][0].PropertyAddress3)
    // console.log("Agent: " + allData[5][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[5][0].PropertyAddress1+allData[5][0].PropertyAddress2+allData[5][0].PropertyAddress3)
    // console.log("Agent: " + allData[6][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[6][0].PropertyAddress1+allData[6][0].PropertyAddress2+allData[6][0].PropertyAddress3)
    // console.log("Agent: " + allData[7][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[7][0].PropertyAddress1+allData[7][0].PropertyAddress2+allData[7][0].PropertyAddress3)
    // console.log("Agent: " + allData[8][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[8][0].PropertyAddress1+allData[8][0].PropertyAddress2+allData[8][0].PropertyAddress3)
    // console.log("Agent: " + allData[9][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[9][0].PropertyAddress1+allData[9][0].PropertyAddress2+allData[9][0].PropertyAddress3)
    // console.log("Agent: " + allData[10][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[10][0].PropertyAddress1+allData[10][0].PropertyAddress2+allData[10][0].PropertyAddress3)
    // console.log("Agent: " + allData[11][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[11][0].PropertyAddress1+allData[11][0].PropertyAddress2+allData[11][0].PropertyAddress3)
    // console.log("Agent: " + allData[12][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[12][0].PropertyAddress1+allData[12][0].PropertyAddress2+allData[12][0].PropertyAddress3)
    // console.log("Agent: " + allData[13][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[13][0].PropertyAddress1+allData[13][0].PropertyAddress2+allData[13][0].PropertyAddress3)
    // console.log("Agent: " + allData[14][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[14][0].PropertyAddress1+allData[14][0].PropertyAddress2+allData[14][0].PropertyAddress3)
    // console.log("Agent: " + allData[15][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[15][0].PropertyAddress1+allData[15][0].PropertyAddress2+allData[15][0].PropertyAddress3)
    // console.log("Agent: " + allData[16][0].PropertyAgent.PropertyAgentFullName, "Property: " +allData[16][0].PropertyAddress1+allData[16][0].PropertyAddress2+allData[16][0].PropertyAddress3)
    // console.log("Palace: ", allData.length)
    // console.log(allData[16][0].PropertyAgent)
    // console.log(allData)
